...
{
	const char* input_filename = (argc > 1) ? argv[1] : "3.xyz";
	const char* output_filename = (argc > 2) ? argv[2] : "3_bilateral_smoothed.xyz";
	...
	double sharpness_angle = 30; // control sharpness of the result.
